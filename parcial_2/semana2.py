...
def show_students():
    ...
    for student in students_list:
        ...
        curso_string = ""
        for curso in student[3]:
            curso_string += f"{curso}, "
...
"""
def add_course_to_course_list(student_id, coursename) -> bool:
    for student in students_list:
        print(student)
        if int(student[1]) == student_id:
            student[3].append(coursename)
            return True
...
def append_user_to_course(course_id = -1, student_id = -1):
    ...
    while student_id == -1:
        ...
        if not add_course_to_course_list(student_id, coursename):
            student_id = -1
